...
{
    public partial class RenewShowTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentToken = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShippingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Address = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Sale__PaymentId__7EF6D905",
                        column: x => x.PaymentId,
                        principalTable: "Payment",
                        principalColumn: "PaymentId");
                    table.ForeignKey(
                        name: "FK__Sale__ShippingId__7FEAFD3E",
                        column: x => x.ShippingId,
                        principalTable: "Shipping",
                        principalColumn: "ShippingId");
                    table.ForeignKey(
                        name: "FK__Sale__ShoeId__7D0E9093",
                        column: x => x.ShoeId,
                        principalTable: "Shoe",
                        principalColumn: "ShoeId");
                    table.ForeignKey(
                        name: "FK__Sale__UserId__7E02B4CC",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
